    ...
    return (
      <Modal show={open} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title className="text-capitalize">Project Code: {title}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {describe ? <p className="lead">Task Code: {describe}</p> : "No Dsecriptions Yet"}
        ...
        <Modal.Footer>
          ...
          <Link to={`/timesheet/event/${id}/update`}><Button variant="success">Update</Button></Link>
